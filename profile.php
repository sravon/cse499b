...
<section class="container-fluid" style="padding:0;max-height:200px;display:inline;opacity: 0.4;">
	<img src="images/doctors.jpg" style="width:100%;height: 200px;">
</section>
		...
		<div class="row">
			<div class="col-md-12 mx-auto">
				<div class="d-flex justify-content-between align-items-center">
					<img style="margin-top: -18px;" class="img-fluid rounded-circle" src="images/32.jpg" width="200" height="200">
					<div>
