...
<section class="container-fluid mt-5">
	<div class="row">
		...
		<div class="col-md-6 p-5">
			<h2 class="text-center p-2 text-light bg-success">Search Schoolarships By Country</h2>
			<form class="border p-3">
			  <div class="form-group row">
			    <label for="exampleFormControlSelect1" class="col-sm-3 col-form-label"><b>Country :</b> </label>
			    <div class="col-sm-9">
				    <select class="form-control">
						  <option>Default select</option>
						  <option>Canda</option>
						  <option>Uganda</option>
						  <option>Taihan</option>
						</select>
					</div>
			  </div>
			  <div class="form-group row">
				  ...
				  <div class="col-sm-4">
				    <button class="btn btn-outline-danger"><b>Add Exam</b></button>
				  </div>
				</div>
				<div class="form-group row">
